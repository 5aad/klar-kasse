...
Contact support is available inside the app from Settings > Customer Support.

## Use of Klar Kasse

You are responsible for the information you enter, scan, save, export, or delete in the app.
